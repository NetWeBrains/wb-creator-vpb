...
$wbcvpb_shortcodes['ul_wbc'] = array(
...
function wbcvpb_ul_wbc_shortcode( $attributes, $content = null ) {
	...
	return '<ul '.esc_attr($id_out).' class="wbcvpb_shortcode_ul '.esc_attr($classes).'" '.$animation_out.'>'.do_shortcode($content).'</ul>';
}


$wbcvpb_shortcodes['li_wbc'] = array(
...
function wbcvpb_li_wbc_shortcode( $attributes, $content = null ) {
	extract(shortcode_atts(wbcvpb_extract_attributes('li_wbc'), $attributes));
