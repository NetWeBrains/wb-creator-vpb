...
$wbcvpb_shortcodes['image_switch_wbc'] = array(
...
function wbcvpb_image_switch_wbc_shortcode( $attributes, $content = null ) {
	extract(shortcode_atts(wbcvpb_extract_attributes('image_switch_wbc'), $attributes));
	$id_out = ($id!='') ? 'id='.$id.'' : '';
	...
	if($link != '') {
		$return .= '<a href="'.esc_url($link).'" target="'.esc_attr($target).'">
			<div class="image"><div class="inner"><img class="wbcvpb_image_first_image" src="'.esc_url($url).'">
			<img class="wbcvpb_image_second_image" src="'.esc_url($url_second).'"></div></div>
			<div class="content">'.do_shortcode($content).'</div>
		</a>';
	}
	else{
		$return .= '<div class="image"><div class="inner"><img class="wbcvpb_image_first_image" src="'.esc_url($url).'">
			<img class="wbcvpb_image_second_image" src="'.esc_url($url_second).'"></div></div>
			<div class="content">'.do_shortcode($content).'</div>';
	}
